...
### Фокус (обновлено 2026-09-11): трек K «свой БКС»

- [x] K0 токен + список UI = holdings (Snowball `/`)
- [x] K1–K2 история операций + кэш SQLite
- [ ] **KA** дневная атрибуция (стоимость, % день, кто тянул Δ)
- [ ] **KB** Focus / Hold
- [ ] K4 карточка avg / дата / PnL (факт, не совет)
- [ ] K3 графики — **низкий приоритет**, не блокер
- Канон: `docs/TZ.md`, part `10-bcs-terminal.md`

### Позже (E–J) / не сейчас

- Новости-чеклист без ордеров (F); авто-watch; телефон
- IDEA-023 forecast-песочница — отложено, не пилить без команды
