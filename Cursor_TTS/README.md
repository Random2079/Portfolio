...
В окне: авто, **движок** (по умолчанию **Silero/local**), голос, громкость, **пауза между кусками**, «Прослушать», **«Пауза»**, «Стоп».  
Движки: **Silero** (быстрый офлайн) · Kokoro-ru · Qwen/micro wife.  
