# Текст для отклика на HH (копипаст)

Подправь под вакансию 1 строку «почему вам» — остальное можно почти как есть.
...
Портфель:
https://github.com/Random2079/Portfolio
```
...
Откликаюсь на вакансию [название]. Пишу на Python утилиты «под задачу»: GUI, вызов внешних инструментов, работа с текстом/API.
...
После отклика имеет смысл **закрепить (Pin)** на GitHub только репозиторий Portfolio.
