...
| 05 | [api-ui](05-api-ui.md) | ✅ A–D / 🟡 E | `api.py`, `static/index.html` |
...
| 10 | [bcs-terminal](10-bcs-terminal.md) | ⬜ K0–K6 | история / графики / разбор |

**Фокус сейчас:** part 10 (K0→). Новостной хвост E–J — по остаточному принципу.
