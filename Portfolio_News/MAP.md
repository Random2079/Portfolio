...
**QA-фиксы 2026-09-26:** кэш графика (`days` + не резать историю), day `missing`/`%` без облигаций, шум ленты (форумы/котировки), metrics/div/coupons limit, kind фонда с BCS.  
